...
class mainWindow(qtw.QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowIcon(qtg.QIcon('./images/mask.png'))  # window icon
        self.setWindowTitle('Face Mask Recognition')  # window title 
        self.setFixedSize(600,600)  # size of the window
    
    
        # Adding Widgets
        label = qtw.QLabel('<h3>Camera Application</h3>') # bigger number at h (h1,h2,h3,...) the smaller the letters become
